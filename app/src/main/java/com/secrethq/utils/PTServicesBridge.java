...
public class PTServicesBridge
	...
	public static void initBridge(Cocos2dxActivity activity, String appId){
		...
		if(appId == null || appId.length() == 0 || !appId.matches("[0-9]+")){
			return;
		}

		SharedPreferences sharedPref = activity.getPreferences(Context.MODE_PRIVATE);
		if(sharedPref.getBoolean("GooglePlayServiceSignInError", false)){
	...
	public static void showLeaderboard( ){
		...
		if(PTServicesBridge.mGoogleApiClient == null || !PTServicesBridge.mGoogleApiClient.isConnected()){
